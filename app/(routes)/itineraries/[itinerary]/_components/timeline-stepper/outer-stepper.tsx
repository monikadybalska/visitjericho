        ...
        {days.map((day, i) => (
          ...
          >
            <Link
              key={i}
              href={`#day${i + 1}`}
              className="absolute w-full min-w-44 h-[120px] z-50 top-0"
            ></Link>
            <h3
              className={`absolute font-medium font-serif top-[4.5rem] w-44 text-center transition-all duration-1000
